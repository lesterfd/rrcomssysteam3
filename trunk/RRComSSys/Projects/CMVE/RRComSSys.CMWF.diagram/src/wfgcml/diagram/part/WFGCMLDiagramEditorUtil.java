 ...
 * @generated
 */
public class WFGCMLDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.WFGCMLDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS
									.bind(
											Messages.WFGCMLDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = WFGCMLDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.WFGCMLDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.WFGCMLDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				WFGCMLRoot model = createInitialModel();
				...
				try {
					modelResource
							.save(wfgcml.diagram.part.WFGCMLDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(wfgcml.diagram.part.WFGCMLDiagramEditorUtil
									.getSaveOptions());
	 ...
	 * @generated
	 */
	private static WFGCMLRoot createInitialModel() {
		return WfgcmlFactory.eINSTANCE.createWFGCMLRoot();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(WFGCMLRoot model,
			Resource resource) {
