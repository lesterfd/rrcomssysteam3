...
public class WFGCMLPaletteFactory {
	...
	private ToolEntry createGCML1CreationTool() {
		...
		entry.setSmallIcon(WFGCMLDiagramEditorPlugin
				.findImageDescriptor("/RRComSSys.CMWF/model/Icons/doc.png")); //$NON-NLS-1$
	...
	private ToolEntry createNext2CreationTool() {
		...
		entry
				.setSmallIcon(WFGCMLDiagramEditorPlugin
						.findImageDescriptor("/RRComSSys.CMWF/model/Icons/connect.png")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createStart3CreationTool() {
		...
		entry.setSmallIcon(WFGCMLDiagramEditorPlugin
				.findImageDescriptor("/RRComSSys.CMWF/model/Icons/start.png")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createFinal4CreationTool() {
		...
		entry.setSmallIcon(WFGCMLDiagramEditorPlugin
				.findImageDescriptor("/RRComSSys.CMWF/model/Icons/finish.png")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createDecision5CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(
				...
				Messages.Decision5CreationTool_desc, types);
		entry
				.setSmallIcon(WFGCMLDiagramEditorPlugin
						.findImageDescriptor("/RRComSSys.CMWF/model/Icons/decision.png")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
