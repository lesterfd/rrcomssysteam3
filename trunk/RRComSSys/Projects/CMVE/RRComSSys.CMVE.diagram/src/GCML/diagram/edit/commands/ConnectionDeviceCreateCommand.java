 ...
 * @generated
 */
public class ConnectionDeviceCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectionDeviceCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GCMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateConnectionDevice_3001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getDevice().add(getTarget());
		}
