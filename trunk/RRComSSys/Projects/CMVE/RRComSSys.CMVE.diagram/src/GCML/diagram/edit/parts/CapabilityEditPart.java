...
import GCML.diagram.edit.policies.CapabilityItemSemanticEditPolicy;
...
public class CapabilityEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CapabilityItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		CapabilityFigure figure = new CapabilityFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CapabilityBuiltInTypeEditPart) {
			((CapabilityBuiltInTypeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCapabilityBuiltInTypeFigure());
			return true;
		}
		return false;
	}
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(getMapMode()
				.DPtoLP(110), getMapMode().DPtoLP(50));
		return result;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GCMLVisualIDRegistry
				.getType(CapabilityBuiltInTypeEditPart.VISUAL_ID));
	}
	...
	public class CapabilityFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureCapabilityBuiltInTypeFigure;
		...
		public CapabilityFigure() {
			...
			this.setMinimumSize(new Dimension(getMapMode().DPtoLP(110),
					getMapMode().DPtoLP(50)));
			this.setSize(getMapMode().DPtoLP(110), getMapMode().DPtoLP(50));
			createContents();
		}
		...
		private void createContents() {
			...
			WrappingLabel lblCapability0 = new WrappingLabel();
			lblCapability0.setText("Capability");

			lblCapability0.setFont(LBLCAPABILITY0_FONT);

			lblCapability0.setBorder(new MarginBorder(getMapMode().DPtoLP(2),
					getMapMode().DPtoLP(20), getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(0)));

			this.add(lblCapability0);

			fFigureCapabilityBuiltInTypeFigure = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCapabilityBuiltInTypeFigure() {
	 ...
	 * @generated
	 */
	static final Font LBLCAPABILITY0_FONT = new Font(Display.getCurrent(),
			"Tahoma", 9, SWT.BOLD);
