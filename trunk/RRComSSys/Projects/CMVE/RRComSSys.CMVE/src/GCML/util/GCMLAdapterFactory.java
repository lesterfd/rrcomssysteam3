...
public class GCMLAdapterFactory extends AdapterFactoryImpl {
	...
	protected GCMLSwitch<Adapter> modelSwitch =
		new GCMLSwitch<Adapter>() {
			@Override
			public Adapter caseGCMLDocument(GCMLDocument object) {
				return createGCMLDocumentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link GCML.GCMLDocument <em>Document</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGCMLDocumentAdapter() {
		return null;
	}
