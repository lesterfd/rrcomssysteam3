...
public class GCMLSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GCMLPackage.GCML_DOCUMENT: {
				GCMLDocument gcmlDocument = (GCMLDocument)theEObject;
				T result = caseGCMLDocument(gcmlDocument);
	 ...
	 * @generated
	 */
	public T caseGCMLDocument(GCMLDocument object) {
		return null;
	}
