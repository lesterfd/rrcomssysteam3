	...
	protected void addDevicesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_Devices_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_Devices_feature", "_UI_Connection_type"),
				 GcmlPackage.Literals.CONNECTION__DEVICES,
				 true,
				 false,
				 true,
				 null,
