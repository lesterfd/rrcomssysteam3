	...
	protected void addCapabilitiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_Capabilities_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_Capabilities_feature", "_UI_Device_type"),
				 GcmlPackage.Literals.DEVICE__CAPABILITIES,
				 true,
				 false,
				 true,
				 null,
