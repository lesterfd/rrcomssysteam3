...
public class DeviceEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DeviceDeviceIDEditPart) {
			((DeviceDeviceIDEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureDeviceDeviceIDFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GCMLVisualIDRegistry
				.getType(DeviceDeviceIDEditPart.VISUAL_ID));
	}
	...
	public class DeviceFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureDeviceDeviceIDFigure;
		...
		private void createContents() {
			...
			WrappingLabel lblDevice0 = new WrappingLabel();
			lblDevice0.setText("Device");

			lblDevice0.setFont(LBLDEVICE0_FONT);

			lblDevice0.setBorder(new MarginBorder(getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(20), getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(2)));

			this.add(lblDevice0);

			fFigureDeviceDeviceIDFigure = new WrappingLabel();
			fFigureDeviceDeviceIDFigure.setText("DeviceID");
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDeviceDeviceIDFigure() {
	 ...
	 * @generated
	 */
	static final Font LBLDEVICE0_FONT = new Font(Display.getCurrent(),
			"Tahoma", 9, SWT.BOLD);
