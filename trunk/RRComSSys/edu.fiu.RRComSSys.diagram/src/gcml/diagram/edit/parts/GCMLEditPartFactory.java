	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case UserSchemaEditPart.VISUAL_ID:
				return new UserSchemaEditPart(view);
			...
			case DeviceDeviceIDEditPart.VISUAL_ID:
				return new DeviceDeviceIDEditPart(view);

			case IsAttachedConnectToDeviceEditPart.VISUAL_ID:
				return new IsAttachedConnectToDeviceEditPart(view);

			case IsAttachedConnectToPersonEditPart.VISUAL_ID:
				return new IsAttachedConnectToPersonEditPart(view);

			case DeviceCapabilitiesEditPart.VISUAL_ID:
				return new DeviceCapabilitiesEditPart(view);

			case ConnectionDevicesEditPart.VISUAL_ID:
				return new ConnectionDevicesEditPart(view);
			}
		}
