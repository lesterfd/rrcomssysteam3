 ...
 * @generated
 */
public class DeviceCapabilitiesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DeviceCapabilitiesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GCMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateDeviceCapabilities_3003(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getCapabilities().add(getTarget());
		}
