 ...
 * @generated
 */
public class IsAttachedConnectToDeviceReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public IsAttachedConnectToDeviceReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return GCMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistIsAttachedConnectToDevice_3001(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return GCMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistIsAttachedConnectToDevice_3001(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setConnectToDevice(null);
		getNewSource().setConnectToDevice(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setConnectToDevice(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
