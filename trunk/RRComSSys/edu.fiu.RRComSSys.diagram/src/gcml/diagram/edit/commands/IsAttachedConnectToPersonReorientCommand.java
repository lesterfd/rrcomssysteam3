 ...
 * @generated
 */
public class IsAttachedConnectToPersonReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public IsAttachedConnectToPersonReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return GCMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistIsAttachedConnectToPerson_3002(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return GCMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistIsAttachedConnectToPerson_3002(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setConnectToPerson(null);
		getNewSource().setConnectToPerson(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setConnectToPerson(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
