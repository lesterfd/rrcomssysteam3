 ...
 * @generated
 */
public class IsAttachedConnectToPersonCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IsAttachedConnectToPersonCreateCommand(
	...
	public boolean canExecute() {
		...
		return GCMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateIsAttachedConnectToPerson_3002(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setConnectToPerson(getTarget());
		}
