 ...
 * @generated
 */
public class ConnectionDevicesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectionDevicesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GCMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateConnectionDevices_3004(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getDevices().add(getTarget());
		}
