	...
	protected void addCapabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_Capability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_Capability_feature", "_UI_Device_type"),
				 GCMLPackage.Literals.DEVICE__CAPABILITY,
				 true,
				 false,
				 true,
				 null,
