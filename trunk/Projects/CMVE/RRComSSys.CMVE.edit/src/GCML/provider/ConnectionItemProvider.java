...
public class ConnectionItemProvider
	...
	protected void addDevicePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_Device_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_Device_feature", "_UI_Connection_type"),
				 GCMLPackage.Literals.CONNECTION__DEVICE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMediumPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_Medium_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_Medium_feature", "_UI_Connection_type"),
				 GCMLPackage.Literals.CONNECTION__MEDIUM,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Connection_type") + " " + connection.getConnectionID();
	}
