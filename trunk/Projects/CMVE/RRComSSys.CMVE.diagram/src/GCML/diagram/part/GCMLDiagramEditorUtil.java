...
public class GCMLDiagramEditorUtil {
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				GCMLDocument model = createInitialModel();
				attachModelToResource(model, modelResource);

				Diagram diagram = ViewService.createDiagram(model,
						GCMLDocumentEditPart.MODEL_ID,
	 ...
	 * @generated
	 */
	private static GCMLDocument createInitialModel() {
		return GCMLFactory.eINSTANCE.createGCMLDocument();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(GCMLDocument model,
			Resource resource) {
