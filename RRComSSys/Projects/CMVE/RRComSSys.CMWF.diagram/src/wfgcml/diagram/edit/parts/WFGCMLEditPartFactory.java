 ...
 * @generated
 */
public class WFGCMLEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case WFGCMLRootEditPart.VISUAL_ID:
				return new WFGCMLRootEditPart(view);

			case GCMLInstanceEditPart.VISUAL_ID:
				return new GCMLInstanceEditPart(view);

			case GCMLInstanceGCMLLocEditPart.VISUAL_ID:
				return new GCMLInstanceGCMLLocEditPart(view);
			...
			case ConditionAltnextEditPart.VISUAL_ID:
				return new ConditionAltnextEditPart(view);

			case HasNextNextEditPart.VISUAL_ID:
				return new HasNextNextEditPart(view);
			}
		}
