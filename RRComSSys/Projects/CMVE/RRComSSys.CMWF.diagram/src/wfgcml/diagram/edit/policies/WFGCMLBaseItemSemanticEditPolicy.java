...
import wfgcml.diagram.edit.helpers.WFGCMLBaseEditHelper;
import wfgcml.diagram.part.WFGCMLVisualIDRegistry;

/**
 * @generated
 */
public class WFGCMLBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(WFGCMLVisualIDRegistry
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest.setParameter(
						WFGCMLBaseEditHelper.EDIT_POLICY_COMMAND, command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateConditionAltnext_3001(Condition source,
				IsNext target) {
			if (source != null) {
				if (source.getAltnext() != null) {
					return false;
				}
			}
			return canExistConditionAltnext_3001(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateHasNextNext_3002(HasNext source,
				IsNext target) {
			if (source != null) {
			...
			return canExistHasNextNext_3002(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistConditionAltnext_3001(Condition source,
				IsNext target) {
		 ...
		 * @generated
		 */
		public static boolean canExistHasNextNext_3002(HasNext source,
				IsNext target) {
