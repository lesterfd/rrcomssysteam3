 ...
 * @generated
 */
public class ConditionAltnextCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConditionAltnextCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return WFGCMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateConditionAltnext_3001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setAltnext(getTarget());
		}
