 ...
 * @generated
 */
public class ConnectionMediumCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectionMediumCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Medium) {
			return false;
		}
		if (getSource() == null) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getMedium().add(getTarget());
		}
