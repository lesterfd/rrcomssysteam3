 ...
 * @generated
 */
public class ConnectionDeviceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectionDeviceReorientCommand(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getDevice().remove(getOldTarget());
		getNewSource().getDevice().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getDevice().remove(getOldTarget());
		getOldSource().getDevice().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
